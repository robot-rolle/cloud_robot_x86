...
def navGoal_callback(msg):           
    global index, count ,marker_index
...
def click_callback(msg):           
    ...
    marker_index_click=MarkerArray()
    marker_index_click.header.frame_id = 'map'
    marker_index_click.action  =  markerArray.ARROW
...
def send_mark():
    ...
    click_sub   = rospy.Subscriber('/clicked_point', PointStamped, click_callback) #订阅rviz内标记按下的位
